def run():
    ...
    print(str(number1) + " is distinct to " + str(number3) + ": " + str(result))

    # [>] [Greater than] -> It compare if one value is greater than other
    result = number3 > number2
    print(str(number3) + " is greater than " + str(number2) + ": " + str(result))
    ...
    result = number3 >= number2
    print(str(number3) + " greater or equal than " + str(number2) + ": " + str(result))

    # [<=] [Less or equal than] -> It compare if one value is greater than other
    result = number1 <= number2
    print(str(number1) + " less or equal than " + str(number2) + ": " + str(result))
